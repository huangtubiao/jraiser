...
// 判断某个对象是否支持then方法，thenable对象指的是具有then方法的对象
function isThenable(obj) { return obj && typeof obj.then === 'function'; }

// 如果value是thenable的，就执行then，否则Promise.resolve，Promise.resolve方法会将这个对象转为Promise对象，然后就立即执行thenable对象的then方法。
...
var Promise = base.createClass(function(executor) {
	...
	// 添加回调函数，如果当前promise的状态为pending状态，则存储回调函数，否则执行回调函数
